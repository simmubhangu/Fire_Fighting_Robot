...
int main(void)
{
	...
	if((Left_white_line > 0x10) || (Center_white_line > 0x10) || (Right_white_line > 0x10))
		...
		{
	      turn_off_ir_proxi_sensors();
		  if((Left_white_line<0x10)&& (Center_white_line<0x10)&&(Right_white_line>0x10)) // far right
		  {
			  forward();
			  velocity(150,100);
			  }

		  if((Left_white_line<0x10)&& (Center_white_line>0x10)&&(Right_white_line<0x10)) // center
		  {
		  ...
		  if((Left_white_line>0x10)&& (Center_white_line<0x10)&&(Right_white_line<0x10)) // far left
		  {
		  ...
		  if((Left_white_line>0x10)&& (Center_white_line>0x10)&&(Right_white_line<0x10)) // slightly left
		  {
			  count++;
			  forward();
			  velocity(120,150);
		  ...
		  if((Left_white_line<0x10)&& (Center_white_line>0x10)&&(Right_white_line>0x10)) // slightly right
		  {
			  count++;
			  forward();
			  velocity(150,120);
